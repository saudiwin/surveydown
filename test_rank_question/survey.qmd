...
sd_question(
  type  = 'matrix',
  id    = 'policy_opinions',
  label = "How much do you agree with the following policy statements?",
  row = c(
    "The government should increase spending on public transportation infrastructure"="q1",
    "Carbon taxes are an effective way to reduce greenhouse gas emissions"="q2",
    "Universal basic income would reduce poverty"="q3"
  ),
  option = c(
